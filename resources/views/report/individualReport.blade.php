...
<div class="container-fluid"><!-- Begin Page Content -->
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4"><h4 class="mb-0 text-gray-800"><span style="font-weight: bold;">{{$user->name}}</span> (Individual Report)</h4></div>

        <div class="card-deck mb-3">
            <div class="card">
                <div class="card-header"><b>{{ __('Employee Detail') }} <span class="text-primary">(ID: {{$user->id}})</span></b></div>
                <div class="card-body">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row px-2">
                            <div class="col-xl-6">
                                    <div class="form-group">
                                        <label class="label" for="applications_count">Total Applications Applied (Overall)</label>
                                        <input class="form-control" type="text" name="applications_count" disabled value="{{$applications_count}}">
                                    </div> 
                                </div>
                                <div class="col-xl-6">
                                    <div class="form-group">
                                        <label class="label" for="applications_this_year_count">Total Applications Applied (This Year)</label>
                            ...
                            <div class="row px-2">
                                <div class="col-xl-6 col-md-6">
                                    <div class="row">
                                        <div class="col">
                                            <div class="form-group">
                                                <label class="label" for="pending_count">Total Pending Applications</label>
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="form-group">
                                                <label class="label" for="approved_count">Total Approved Applications</label>
                                                <input class="form-control" type="text" name="approved_count" disabled value="{{$approved_count}}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col">
                                            <div class="form-group">
                                                <label class="label" for="rejected_count">Total Rejected Applications</label>
                                                <input class="form-control" type="text" name="rejected_count" disabled value="{{$rejected_count}}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-6 col-md-6">
                                        <div class="chart-pie">
                                            ...
                                            <div class="no-data" id="individualappstatuschartnone">No data available!</div>
                                        </div>
                                </div>
                            </div>
                            <hr>
                            <div class="row px-2">
                                <div class="col-xl-6">
                                    <div class="form-group">
                                        <label class="label" for="applications_days_taken_sum">Application Days Taken (This Year)</label>
                                        <input class="form-control" type="text" name="applications_days_taken_sum" disabled value="{{$applications_days_taken_sum}}">
                                    </div> 
                                </div>
                                <div class="col-xl-6">
                                    <div class="form-group">
                                        <label class="label" for="applications_days_taken_avg">Average Application Days Taken (Per Application)</label>
                                        <input class="form-control" type="text" name="applications_days_taken_avg" disabled value="{{$applications_days_taken_avg}}">
                                    </div> 
                                </div>
                            </div>
                    </div>
