                                ...
                                <div class="row px-2">
                                    ...
                                    <div class="col-xl-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="applications_this_year_count"
                                                disabled value="{{$applications_this_year_count}}">
                                        </div>
                                    </div>
                                </div>
                                <hr>
                                            ...
                                            <div class="col">
                                                <div class="form-group">
                                                    <label class="label" for="pending_count">Total Pending
                                                        Applications</label>
                                                    <input class="form-control" type="text" name="pending_count"
                                                        disabled value="{{$pending_count}}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col">
                                                <div class="form-group">
                                                    <label class="label" for="approved_count">Total Approved
                                                        Applications</label>
                                                    <input class="form-control" type="text" name="approved_count"
                                                        disabled value="{{$approved_count}}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col">
                                                <div class="form-group">
                                                    <label class="label" for="rejected_count">Total Rejected
                                                        Applications</label>
                                                    <input class="form-control" type="text" name="rejected_count"
                                                        disabled value="{{$rejected_count}}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row px-2">
                                    <div class="col-xl-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="applications_days_taken_sum"
                                                disabled value="{{$applications_days_taken_sum}}">
                                        </div>
                                    </div>
                                    <div class="col-xl-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="applications_days_taken_avg"
                                                disabled value="{{$applications_days_taken_avg}}">
                                        </div>
                                    </div>
                                </div>
                            </div>
