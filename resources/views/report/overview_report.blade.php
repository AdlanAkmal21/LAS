                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="taken_so_far_sum_average"
                                                disabled value="{{$taken_so_far_sum_average}}">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-xl-4">
                                        <div class="form-group">
                                            <label class="label" for="applications_this_year_count">Total Applications
                                                (Other Year):</label>
                                            <input class="form-control" type="text" name="applications_this_year_count"
                                                disabled value="{{$applications_other_year_count}}">
                                        </div>
                                    </div>
                                </div>
                                <hr>
                                    ...
                                    <div class="col-xl-4">
                                        <div class="form-group">
                                            <label class="label" for="pending_this_year_count">Total Pending Application
                                                (This Year):</label>
                                            <input class="form-control" type="text" name="pending_this_year_count"
                                                disabled value="{{$pending_this_year_count}}">
                                        </div>
                                    </div>
                                    <div class="col-xl-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="approve_this_year_count"
                                                disabled value="{{$approve_this_year_count}}">
                                        </div>
                                    </div>
                                    <div class="col-xl-4">
                                        <div class="form-group">
                                            <label class="label" for="reject_this_year_count">Total Rejected
                                                Applications (This Year):</label>
                                            <input class="form-control" type="text" name="reject_this_year_count"
                                                disabled value="{{$reject_this_year_count}}">
                                        </div>
                                    </div>
                                </div>
                            </div>
