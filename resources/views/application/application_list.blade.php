                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a href="{{ route('application.show', $active)}}" class="dropdown-item">Show</a>
                                    @if($active->application_status_id == 1)
                                    <a href="{{ route('application.edit', $active)}}"
                                        class="dropdown-item text-success">Edit</a>
                                    <div class="dropdown-divider"></div>

                                    <form action="{{ route('application.destroy', $active)}}" method="post">
                                        @csrf
                                        @method('DELETE')
                        ...
                        <td>
                            <div class="dropdown">
                                <button class="btn btn-primary btn-sm btn-block dropdown-toggle"
                                    data-toggle="dropdown">More</button>
                                <div class="dropdown-menu">
                                    <a href="{{ route('application.show', $past)}}" class="dropdown-item">Show</a>
                                    @if ($past->application_status_id == 1 && $past->leave_type_id != 1)
                                    <a href="{{ route('application.edit', $past)}}"
                                        class="dropdown-item text-success">Edit</a>
                                    @endif
                                    @if ($past->leave_type_id != 1 && $past->application_status_id != 3)
                                    <div class="dropdown-divider"></div>
                                    <form action="{{ route('application.destroy', $past)}}" method="post">
                                        @csrf
                                        @method('DELETE')
                                        <input class="dropdown-item text-danger" role="button" type="submit"
                                            value="Delete">
                        ...
                        <td>
                            <div class="dropdown">
                                <button class="btn btn-primary btn-sm btn-block dropdown-toggle"
                                    data-toggle="dropdown">More</button>
                                <div class="dropdown-menu">
                                    <a href="{{ route('application.show', $medical)}}" class="dropdown-item">Show</a>
                                    <div class="dropdown-divider"></div>
                                    <form action="{{ route('application.destroy', $medical)}}" method="post">
                                        @csrf
                                        @method('DELETE')
                                        <input class="dropdown-item text-danger" role="button" type="submit"
                                            value="Delete">
