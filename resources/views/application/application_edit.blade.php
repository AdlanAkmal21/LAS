            ...
            <div class="row">
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="id" readonly value="{{$application->user->id}}">
                    </div>
                </div>
                <div class="col-6">
                    <div class="form-group">
            ...
            <div class="row">
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" placeholder="dd/mm/yyyy" name="from" type="text" id="from"
                            value="{{ old('from', $from)}}">
                    </div>
                </div>
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" placeholder="dd/mm/yyyy" name="to" id="to"
                            value="{{ old('to', $to)}}">
                    </div>
                </div>
            </div>
