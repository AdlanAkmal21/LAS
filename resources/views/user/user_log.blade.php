...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb small">
        ...
        <li class="breadcrumb-item active" aria-current="page">Work From Home</li>
    </ol>
</nav>
            ...
            <div class="col-xl-8 col-lg-8 pr-xl-5 pr-lg-5">
                <div class="row my-3">
                    <div class="col-xl-6 mb-xl-0 mb-3">
                        <input class="form-control text-center" type="text" name="clock_in" id="clock_in" readonly @if
                            (empty($today->clock_in)) value="--:--:--"
                        @else
                ...
                <div class="row my-3">
                    <div class="col-xl-6 mb-xl-0 mb-3">
                        <input class="form-control text-center" type="text" name="clock_out" id="clock_out" readonly @if
                            (empty($today->clock_out)) value="--:--:--"
                        @else
