<ul class="navbar-nav bg-gradient-indigo sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item active">
      <a class="nav-link" @if(Auth::user()->role_id == 1) href="{{ route('admins.index') }}" @elseif(Auth::user()->role_id == 2) href="{{ route('employees.index') }}" @elseif(Auth::user()->role_id == 3) href="{{ route('approvers.index') }}" @endif>
  ...
  @if (Auth::user()->role_id == 1) <!-- Admin Section -->
    <!-- Divider -->
    ...
    <li class="nav-item">
      <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#AdminReport" aria-expanded="true" aria-controls="collapseTwo">
    ...
    <li class="nav-item">
      <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#AdminManagement" aria-expanded="true" aria-controls="collapseUtilities">
      ...
      <div id="AdminManagement" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
          ...
          <a class="collapse-item" href="{{ route('admins.applicationlist') }}">Applications List</a>
    ...
    @if (Auth::user()->role_id == 2 || Auth::user()->role_id == 3) <!-- Employee Section -->
    <!-- Divider -->
    <hr class="sidebar-divider">
    <!-- Heading -->
    <div class="sidebar-heading">
    ...
    <!-- Nav Item - Pages Collapse Menu -->
    <li class="nav-item">
      <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#EmployeeManagement" aria-expanded="true" aria-controls="collapsePages">
      ...
      <div id="EmployeeManagement" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
          ...
          <a class="collapse-item" href="{{ route('employees.show', Auth::id())}}">Employee Details</a>
    ...
    @if (Auth::user()->role_id == 3) <!-- Approver Section -->
    <!-- Divider -->
    <hr class="sidebar-divider">
    <!-- Heading -->
    <div class="sidebar-heading">
    ...
    <li class="nav-item">
      <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#ApproverManagement" aria-expanded="true" aria-controls="collapsePages">
        <i class="fas fa-fw fa-file-alt"></i>
        <span>Management</span>
      </a>
      <div id="ApproverManagement" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
          ...
          <a class="collapse-item" href="{{ route('approvers.approverlist', Auth::id()) }}">Applications List</a>
          <a class="collapse-item" href="{{ route('approvers.applicantlist', Auth::id()) }}">Applicants List</a>
        </div>
      </div>
    </li>
    @endif
