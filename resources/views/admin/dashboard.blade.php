    ...
    <div class="col-xl-6 col-lg-12 mb-2 mb-xl-0">
        <div class="card shadow" style="height: 100%;">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col">
                        <a href="{{ route('admin.create') }}" class="btn btn-primary btn-sm btn-block">Add Employee
                        </a>
                        <a href="{{ route('holiday.create') }}" class="btn btn-warning btn-sm btn-block">Add Holiday
                        </a>
                        <a href="{{ route('report.overview') }}" class="btn btn-success btn-sm btn-block">Overview
                            Report
                        </a>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-xl-6 col-lg-12 my-1">
                <div class="card border-left-primary shadow h-100 py-2">
                    <div class="card-body">
                        <a href="{{ route('admin.employee_list') }}" class="stretched-link"></a>
        ...
        <div class="row">
            <div class="col-xl-6 col-lg-12 my-1">
                <div class="card border-left-success shadow h-100 py-2">
                    <div class="card-body">
                        <a href="{{ route('admin.application_list') }}" class="stretched-link"></a>
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
        ...
        <div class="row">
            <div class="col-xl-6 col-lg-12 my-1">
                <div class="card border-left-dark shadow h-100 py-2">
                    <div class="card-body">
                        <a href="{{ route('holiday.index') }}" class="stretched-link"></a>
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
