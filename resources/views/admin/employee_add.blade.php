        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    ...
                    <a type="button" class="btn btn-success btn-sm" href="{{ route('admins.employeelist') }}">To
                        Employees List</a>
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <form method="POST" action="{{ route('admins.store') }}">
                            ...
                            <div class="form-group row">
                                <label for="ic"
                                    class="col-md-4 col-form-label text-md-right">{{ __('IC Number') }}</label>

                                <div class="col-md-6">
                                    <input id="ic" data-inputmask="'mask': '999999-99-9999'" type="text"
                                        class="form-control" name="ic" placeholder="Enter IC Number.."
                                        value="{{ old('ic') }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <label for="date_joined"
                                    class="col-md-4 col-form-label text-md-right">{{ __('Date Joined') }}</label>
                            ...
                            <div class="form-group row">
                                <label for="approver_id"
                                    class="col-md-4 col-form-label text-md-right">{{ __('Approved By') }}</label>
